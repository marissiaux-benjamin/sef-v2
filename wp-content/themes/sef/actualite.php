...
<main>
    <section class="intro wrapper">
        ...
        <div class="img-actu-container">
            <img src="<?= $picture_actu ?>" srcset="<?= $picture_actu ?>, <?= $photo_intro_actu['sizes']['large'] ?> 2x"
                 alt="<?= $alt_actu ?>" class="img-actu-container__contenu-actu">
            <img src="http://sef-aout.test/wp-content/uploads/2024/08/img-actu-fond-2.svg" alt="fond de couleur orange"
                 class="img-actu-container__fond">
            <img src="http://sef-aout.test/wp-content/uploads/2024/08/img-actu-fond.svg" alt="fond de couleur orange"
                 class="img-actu-container__fond">
        </div>
    </section>
