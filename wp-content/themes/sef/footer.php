<footer class="footer wrapper">
    <div class="footer-sections">
        <section class="footer-sections__reseaux">
            <h1>
                Réseau social
            </h1>
            <a href="https://www.facebook.com/sef.huy/?locale=fr_FR" target="_blank"
               title="Aller sur le facebook du SEF">Facebook</a>
        </section>
        <section class="footer-sections__coordonnees">
            <h1>
                Coordonn&eacute;es
            </h1>
            <ul>
                ...
                <li>
                    Tel&nbsp;: <a href="tel:+3285215752" title="Télélphoner au SEF">+32 (0) 85 21 57 52 </a>
                </li>
                <li>
                    Mail&nbsp;: <a href="mailto:contact@sefasbl.com"
                                   title="Contacter le SEF par mail">contact@sefasbl.com</a>
                </li>
                <li>
                    Numéro de compte: BE43 2400 2934 2201
                </li>
            </ul>
        </section>
        <section class="footer-sections__soutien">
            <h1>
                Nous soutenir
            </h1>
            <ul>
        ...
        <section class="footer-sections__nav">
            <h1>
                Navigation
            </h1>
            <ul>
